...
var config = {
  ...
  function preload() {
    ...
    this.load.image('pickUpIcon', '/backend/static/sprite_sheets/PickUp.png');
    this.load.image('tiles', '/backend/static/tilemaps/TileSet_V2.png');
    //this.load.image('Water', 'static/tilemaps/water_animation_spritesheet.png');
    this.load.tilemapTiledJSON('map', '/backend/static/tilemaps/map_test5.tmj')
    this.load.spritesheet('player', '/backend/static/sprite_sheets/playerr.png', { frameWidth: 64, frameHeight: 64 });
  } 
